...
async function main() {
    try {
        ...
        const wallet = await Wallets.newFileSystemWallet('./farmer/applications/my_application/wallet/');
        ...
        const my_wallet = await Wallets.newFileSystemWallet('./farmer/applications/APPandUI/wallet/'+identityLabel);
        ...
        let pathToFile = path.resolve(require('os').homedir(), 'go/src/github.com/hyperledger/fabric-samples/securitization-network/tfm-network/fabric-ca/farmer/users/'+identityLabel+'/');
