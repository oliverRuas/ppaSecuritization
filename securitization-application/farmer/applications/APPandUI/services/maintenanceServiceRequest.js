...
class MaintenanceServiceRequest{
    async maintenanceServiceRequest(user, ppaID,serviceType) {
        ...
        const functionName = 'MaintenanceServiceRequest';
        ...
        try{
            ...
            const response = await tx.submit(ppaID,serviceType);
...
module.exports=MaintenanceServiceRequest