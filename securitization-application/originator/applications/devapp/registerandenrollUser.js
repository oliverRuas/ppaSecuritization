...
async function main() {
    try {
        ...
        const wallet = await Wallets.newFileSystemWallet('./originator/applications/my_application/wallet/');
        ...
        // const orgName = 'originator.securitization.com';
        ...
        const ca = new FabricCAServices(connectionProfile['certificateAuthorities'][`rootca.originator.securitization.com`].url);
        ...
        const my_wallet = await Wallets.newFileSystemWallet('./originator/applications/APPandUI/wallet/'+identityLabel);
        ...
        let pathToFile = path.resolve(require('os').homedir(), 'go/src/github.com/hyperledger/fabric-samples/securitization-network/tfm-network/fabric-ca/originator/users/'+identityLabel+'/');
