...
async function main() {
    try {
        ...
        const orgNameWithoutDomain ='ratingagency';
        ...
        const ca = new FabricCAServices(connectionProfile['certificateAuthorities'][`rootca.ratingagency.securitization.com`].url);
        ...
        const my_wallet = await Wallets.newFileSystemWallet('./ratingagency/applications/APPandUI/wallet/'+identityLabel);
        ...
        let pathToFile = path.resolve(require('os').homedir(), 'go/src/github.com/hyperledger/fabric-samples/securitization-network/tfm-network/fabric-ca/ratingagency/users/'+identityLabel+'/');
